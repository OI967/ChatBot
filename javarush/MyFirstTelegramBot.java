...
public class MyFirstTelegramBot extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        ...
        return "My_JavaRush_bot";
    }

    @Override
    public String getBotToken() {
        // TODO: додай токен бота в лапки нижче
        return "6846507841:AAFjIW8Uvzjge_mqsFrgaL3QbFM4UyJuJCc";
    }
            ...
            if (update.hasCallbackQuery()) {
                ...
                if(update.getCallbackQuery().getData().equals("step_7_btn") && getGlories(chatId) == 180) {
                    ...
                    SendMessage message = createMessage(chatId, STEP_8_TEXT, Map.of(
                            "Вийти на подвір'я", "step_8_bt"));
sendApiMethodAsync(message);
                }
                if(update.getCallbackQuery().getData().equals("step_8_bt") && getGlories(chatId) == 230) {
                    addGlories(chatId, 50);
